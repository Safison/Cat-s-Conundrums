...
# It will need to return a list of all possible sub-lists given some starting list
...
# You will need to write your own tests for this task to prove your function is working correctly, we have written the first test for you
