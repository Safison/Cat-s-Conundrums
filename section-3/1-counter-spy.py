...
def test_counter_spy_returns_a_list_with_all_spies_removed():
    ...
    assert counter_spy(['Simon', 'Alex', 'Cat', 'Chon', 'Kyle', 'Danika']) == ['Alex', 'Cat', 'Chon', 'Danika']
...
def test_counter_spy_returns_a_list_with_names_in_alphabetical_order():
    assert counter_spy(['Simon', 'Mick', 'Cat', 'Kyle', 'Danika', 'Alex', 'Chon']) == ['Alex', 'Cat', 'Chon', 'Danika', 'Mick']
